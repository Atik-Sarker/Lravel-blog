                            ...
                            <div class="box-body">
                                ...
                                <div class="col-lg-offset-2 col-lg-8">
                                    <div class="form-group">
                                        <label for="permission" class="{{ $errors->has('permission') ? ' error' : '' }}">Permission</label>
                                        <input type="text" class="form-control" id="permission" name="name" placeholder="write permission here" value="{{old('name')}}">
                                        @if ($errors->has('name'))
