                            ...
                            <div class="box-body">
                                ...
                                <div class="col-lg-offset-2 col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tag" name="tag" placeholder="write tag here" value="{{$tag->name}}">
                                        @if ($errors->has('tag'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tag_slug" name="slug" placeholder="write tag slug here" value="{{$tag->slug}}">
                                        @if ($errors->has('slug'))
                                            <span class="error" role="alert">
