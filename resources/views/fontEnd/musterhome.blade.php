            ...
            <div class="featured-wrap">
                ...
                <div class="col-md-5 col-sm-12">
                    <div class="post-carousel owl-carousel">
                        ...
                        <div class="featured-post" style="background-image: url({{asset("storage/postImage/{$post->id}.{$post->image}")}})">
                            <div class="post-info">
                                <a href="#" class="cat-name tt-u">{{ $post->title }}</a>
                                <h3 class="fw-6 fz-16"><a href="#" class="text-white">{{ $post->subtitle }}</a></h3>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="post-carousel owl-carousel">
                        ...
                        <div class="featured-post" style="background-image: url({{asset("storage/postImage/{$categoryCost->id}.{$categoryCost->image}")}})">
                            <div class="post-info">
                                <a href="#" class="cat-name tt-u">{{ $categoryCost->title }}</a>
                                <h3 class="fw-6 fz-16"><a href="#" class="text-white">{{ $categoryCost->subtitle }} </a></h3>
                            </div>
                        </div>
                        @endforeach
                    </div><!-- /.post-carousel -->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="top-wrap mb-10">
                        ...
                        <div class="post-carousel owl-carousel">
                            <div class="featured-post" style="background-image: url({{asset("storage/postImage/{$categoryPost1->id}.{$categoryPost1->image}")}});">
                                <div class="post-info">
                                    <a href="#" class="cat-name tt-u">{{ mb_strimwidth($categoryPost1->title, 0, 20, "...") }}</a>
                                    <h3 class="fw-6 fz-16"><a href="#" class="text-white">{{ $categoryPost1->subtitle }}</a></h3>
                                </div>
                            </div>
                        </div><!-- /.post-carousel -->
                        @endforeach
                    ...
                    <div class="bottom-wrap">
                        <div class="post-carousel owl-carousel">
                            @foreach($categoryPosts2 as $categoryPost2)
                                <div class="featured-post" style="background-image: url({{asset("storage/postImage/{$categoryPost2->id}.{$categoryPost2->image}")}});">
                                    <div class="post-info">
                                        <a href="#" class="cat-name tt-u">{{ $categoryPost2->title }}</a>
                                        <h3 class="fw-6 fz-16"><a href="#" class="text-white">{{ $categoryPost2->subtitle }}</a></h3>
                                    </div>
                                </div>
                            @endforeach
                        </div><!-- /.post-carousel -->
            ...
            <div class="main-content mt-20 ov-hidden">
                <div class="col-md-8 sm-padding">
                    <div class="news-block padding-15 bg-white bd-grey mb-40">
                        ...
                        <div class="grid-posts">
                            <div class="col-xs-6 padding-10">
                                <div class="grid-post">
                                    <a href="#" class="mb-20"><img src="{{ asset('endUser') }}/img/trending-1.jpg" alt="Tranding News"></a>
                            ...
                            <div class="col-xs-6 padding-10">
                                <div class="grid-post">
                                    <a href="#" class="mb-20"><img src="{{ asset('endUser') }}/img/trending-2.jpg" alt="Tranding News"></a>
                                    <div class="post-info padding-15 ptb-20 bd-grey">
                                        <h4 class="mb-15 fw-6"><a href="#" class="text-dark">The future of possible innovation for business company.</a></h4>
                                        <span class="date"><i class="ti-timer"></i> November 16 , 2017</span>
                                    </div>
                            ...
                            <div class="col-xs-6 padding-10">
                                <div class="grid-post">
                                    <a href="#" class="mb-20"><img src="{{ asset('endUser') }}/img/trending-3.jpg" alt="Tranding News"></a>
                                    <div class="post-info padding-15 ptb-20 bd-grey">
                                        <h4 class="mb-15 fw-6"><a href="#" class="text-dark">The future of possible innovation for business company.</a></h4>
                                        <span class="date"><i class="ti-timer"></i> November 16 , 2017</span>
                                    </div>
                            ...
                            <div class="col-xs-6 padding-10">
                                <div class="grid-post">
                                    <a href="#" class="mb-20"><img src="{{ asset('endUser') }}/img/trending-4.jpg" alt="Tranding News"></a>
                                    <div class="post-info padding-15 ptb-20 bd-grey">
                                        <h4 class="mb-15 fw-6"><a href="#" class="text-dark">The future of possible innovation for business company.</a></h4>
                                        <span class="date"><i class="ti-timer"></i> November 16 , 2017</span>
                                    </div>
                    ...
                    <div class="news-block padding-15 bg-white bd-grey mb-40">
                        ...
                        <div class="two-col-posts">
                            <div class="col-md-6 padding-10">
                                <div class="post-item">
                                    <a href="#" class="mb-20"><img src="{{ asset('endUser') }}/img/world-1.jpg" alt="World News"></a>
                                    <div class="post-info padding-15 ptb-20 bd-grey">
                                        <h4 class="mb-15 fw-6"><a href="#" class="text-dark">The future of possible innovation for business company.</a></h4>
                                        <span class="date"><i class="ti-timer"></i> November 16 , 2017</span>
                                    </div>
                            ...
                            <div class="col-md-6 padding-10">
                                <div class="small-posts">
                                    <div class="sm-post-item">
                                        <img src="{{ asset('endUser') }}/img/world-2.jpg" alt="World News">
                                    ...
                                    <div class="sm-post-item">
                                        <img src="{{ asset('endUser') }}/img/world-3.jpg" alt="World News">
                                        <div class="sm-post-content bd-grey">
                                    ...
                                    <div class="sm-post-item">
                                        <img src="{{ asset('endUser') }}/img/world-4.jpg" alt="World News">
                                        <div class="sm-post-content bd-grey">
                        ...
                        <div class="side-tab">
                            ...
                            <div class="col-md-6 padding-10">
                                <ul class="video-thumbs">
                                    <li class="active">
                                        <img src="{{ asset('endUser') }}/img/video-1.jpg" alt="Featured Video">
                                    ...
                                    <li>
                                        <img src="{{ asset('endUser') }}/img/video-2.jpg" alt="Featured Video">
                                    ...
                                    <li>
                                        <img src="{{ asset('endUser') }}/img/video-3.jpg" alt="Featured Video">
                                    ...
                                    <li>
                                        <img src="{{ asset('endUser') }}/img/video-4.jpg" alt="Featured Video">
                    ...
                    <div class="banner-in-content padding-15 bg-white bd-grey ov-hidden mb-40">
                        <a href="#"><img src="{{ asset('storage') }}/{{ $appearance->banner_footer }}" alt="Banner AD"></a>
                        ...
                        <div class="news-items">
                            <div class="col-xs-12 padding-10">
                                <div class="list-post-item">
                                    <a href="#" class="img-thumb"><img src="{{ asset('endUser') }}/img/sports-1.jpg" alt="Sports News"></a>
                                    <div class="post-info padding-15 ptb-20 bd-grey">
                            ...
                            <div class="col-md-3 col-xs-6 padding-10">
                                <a href="#"><img src="{{ asset('endUser') }}/img/sports-2.jpg" class="img-full" alt="Sports News"></a>
                            </div>
                            <div class="col-md-3 col-xs-6 padding-10">
                                <a href="#"><img src="{{ asset('endUser') }}/img/sports-3.jpg" class="img-full" alt="Sports News"></a>
                            </div>
                            <div class="col-md-3 col-xs-6 padding-10">
                                <a href="#"><img src="{{ asset('endUser') }}/img/sports-4.jpg" class="img-full" alt="Sports News"></a>
                            </div>
                            <div class="col-md-3 col-xs-6 padding-10">
                                <a href="#"><img src="{{ asset('endUser') }}/img/sports-5.jpg" class="img-full" alt="Sports News"></a>
                            </div>
                        </div>
                    </div><!-- /.news-block -->
...
{{--@section('bg-img', asset('fontEnd/img/home-bg.jpg'))--}}

{{--@section('heading',"News 24")--}}

{{--@section('sub_heading', "News Title Here")--}}
